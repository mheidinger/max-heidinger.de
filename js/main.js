(function() {
	...
	function modalTransition(open) {
		...
		if (open) {
			...
			transition.begin(modalContent[0], "transform scale(0) scale(1) 0.1 ease-in-out")
		} else {
			transition.begin(modalContent[0], "transform scale(1) scale(0) 0.1 ease-in-out", { onTransitionEnd: () => modal.css("display", "none") });
		}
	}
})();